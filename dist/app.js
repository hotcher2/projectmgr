...
var ProjectState = /** @class */ (function (_super) {
    ...
    ProjectState.prototype.moveProject = function (projectId, newStatus) {
        var project = this.projects.filter(function (prj) { return prj.id === projectId; })[0];
...
function validate(validatableInput) {
    ...
    if (validatableInput.minLength != null && // != checks for null and undefined, !== checks only null
        typeof validatableInput.value === "string") {
        isValid =
            isValid && validatableInput.value.length >= validatableInput.minLength;
    }
    if (validatableInput.maxLength != null && // != checks for null or undefined, !== checks only null
        typeof validatableInput.value === "string") {
        isValid =
...
var ProjectListItem = /** @class */ (function (_super) {
    ...
    function ProjectListItem(type, project) {
        var _this = _super.call(this, "single-project", type + "-projects-list", false, Math.random().toString()) || this;
        _this.project = project;
        _this.configure();
        _this.renderContent();
        return _this;
    }
    Object.defineProperty(ProjectListItem.prototype, "persons", {
        get: function () {
    ...
    ProjectListItem.prototype.dragStartHandler = function (event) {
        var _a;
        (_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.setData("text/plain", this.project.id);
        event.dataTransfer.effectAllowed = "move";
    };
    ProjectListItem.prototype.dragEndHandler = function (event) {
        console.log("drag end event");
    };
    ProjectListItem.prototype.configure = function () {
        this.element.addEventListener("dragstart", this.dragStartHandler);
        this.element.addEventListener("dragend", this.dragEndHandler);
    };
    ProjectListItem.prototype.renderContent = function () {
